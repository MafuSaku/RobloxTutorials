...
FriendInviteGui.MouseButton1Click:Connect(function()
    if SocialService:CanSendGameInviteAsync(localPlayer.UserId) then -- If you dont have localPlayer then use game.Players.LocalPlayer
            ...
            ExperienceInviteOptions.LaunchData = localPlayer.UserId -- This is the data that will be sent to the player when they join your game again, if you dont have localPlayer then use game.Players.LocalPlayer.UserId
